    ...
    <div class="container">
        <div class="years__project_grid">
            ...
            <div>
               ...
               <br><br> <p class="main_text_item"><b>Миссия конкурса -</b> <span class="main_text_span"> поиск, отбор и поддержка социальных проектов с применением цифровых технологий, которые влияют на позитивные изменения в обществе.</span></p>
               <br><br> <p class="main_text_item"><b>Задачи конкурса:</b></p>
               <br> <ul class="project_ul">
                ...
                <br><p class="main_text_item"><b>Участниками конкурса могут быть</b> совершеннолетние граждане – авторы социальных проектов с применением цифровых технологий: </p>
                <br><ul class="project_ul">
                ...
                <br><p class="main_text_item"><b>Проекты к участию принимаются в трех номинациях:</b></p>
                <br><ul class="project_ul">
