            ...
            <div class="about__tender_modal_items">
                ...
                <div class="about__tender_modal_items_2">
                    ...
                    <div class="btn__modal_tender">
                        ...
                        <a type="button" class="btn btn__modal_tender" data-bs-toggle="modal" data-bs-target="#modal__tender">ПОДРОБНЕЕ <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
