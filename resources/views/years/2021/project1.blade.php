            ...
            <div>
                ...
                <ul class="project_ul">
                    <li class="project_main_li_item">
                        ...
                        <span class="main_text_span"> - a concept for the integration of information and communication technologies for urban property management in order to solve or mitigate existing social problems in society and improve the quality of life of the population as a whole </span>
                    </li>
                </ul>
                </p>
            </div>
