        ...
        <div class="years__project_grid">
            <div class="years__project_sticky">
                ...
                <div class="years__project_date">
                    <div class="years__project_date_items">
                        ...
                        <p> November 11, 2015 - March 1, 2016 </p>
                        <p> Acceptance of bids </p>
                    </div>
                    <div class="years__project_date_items">
                        <p> Summary </p>
                        <p> April 2016 </p>
                        <p> Announcement of summarized results </p>
                    </div>
                </div>
                @endif
            </div>
            ...
            <div>
                ...
                <p>
                    ...
                    <br> <br>
                    The main objective of the competition is to support and promote legal content on the Internet, including audio, video and book products, and to increase the number of responsible content users.
                    <br> <br>
                    High school students, students, young professionals and everyone who wants to share the point of view that licensed films, music, books and other results of intellectual creative activity on the Internet should be available to a wide user in good quality for a certain fee are invited to participate in the competition "For Legal Content" ...
                    <br> <br>
                    Paying for movies, music and books online is as natural as buying a movie, concert, or book ticket from a bookstore. Downloading for free, bypassing the law, should become not just illegal, but not fashionable.
                    <br> <br>
                    We invite the participants of the competition to create their own video on this topic, post it on Youtube and send a link to the video in the application for participation in the competition on the telecomideas.com website.
                    <br> <br>
                    Requirements for the video: can be filmed on any smartphone or other device with a video recording function. Duration - up to 1 minute.
