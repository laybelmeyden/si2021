    ...
    <div id="app" class="nav__items">
        ...
        <div class="table__all_users">
            ...
            <p>
                ...
                </svg> - посмотреть пользователя <br>
                ...
                </svg> - редактировать пользователя <br>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" class="bi bi-person-x-fill">
                ...
                </svg> - удалить пользователя <br>
            </p>
            <div class="info__color">
                <div class="item"></div>
                <p>- цветом выделены Участники региональной программы Social Idea 2021 «IT-Start»</p>
            </div>
            <div class="serach__users">
                <form action="/search" method="get">
                    <label for="serach">Поиск пользователей</label>
                    <div class="btn__file">
