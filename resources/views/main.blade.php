    ...
    <div class="container">
        ...
        <div class="grid__nominations">
            <div class="grid__nominations_1">
                ...
                <p>ЭКОЛОГИЯ</p>
                <span>идеи и решения, основанные на принципах энерго- и ресурсосбережения, инновационные разработки, нацеленные на сокращение объема отходов и выбросов, повторное использование ресурсов и направленные на формирование ответственного подхода к охране окружающей среды</span>
            </div>
        ...
        <div class="swiper-container swiper-container-experts">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="experts__slide_items">
                        <div>
                            <img loading="lazy" src="assets/img/speakers/alW5kZ13p8E.jpg" alt="Mnagib.jpg">
                        </div>
    ...
    <div class="container">
        ...
        <div class="col-lg-12">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-3 col-3 particul_part">
                    <a href="https://ru.jobsora.com/"><img loading="lazy" src="assets/img/logo4444444444444.png" class="img_partners"></a>
                </div>
                <div class="col-lg-2 col-md-3 col-3 particul_part">
